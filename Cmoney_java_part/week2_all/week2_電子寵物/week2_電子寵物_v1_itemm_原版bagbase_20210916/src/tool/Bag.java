...
public class Bag {
    ...
    public void setContainer(Base[] container) {
        this.container = container;
    }

    public Item[] getContainer2() {
        return container2;
    }

    public void setContainer2(Item[] container2) {
    ...
    public void setCurrentBaseIndex(int currentBaseIndex) {
