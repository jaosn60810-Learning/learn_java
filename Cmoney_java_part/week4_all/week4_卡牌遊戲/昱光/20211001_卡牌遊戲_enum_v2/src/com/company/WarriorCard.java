...
import java.util.ArrayList;
    ...
    public enum WarriorCard implements CardEffect {
        ...
        public Card getThisCard(){
            ...
            return new Card(thisCard.getNumber(), thisCard.getName(),
                    thisCard.getPoint(), thisCard.getEffect(), thisCard.getValue(),
                    thisCard.getCost(), thisCard.getType(), thisCard.getEffectCount());
        }
        ...
        public Card[] getAllCard() {
            ...
            for (WarriorCard allCard : WarriorCard.values()) {
                card[i++] = new Card(allCard.getNumber(), allCard.getName(),
                        allCard.getPoint(), allCard.getEffect(), allCard.getValue(),
                        allCard.getCost(), allCard.getType(), allCard.getEffectCount());
            }
            return card;
        }
