...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 印出所有動物
        System.out.println("印出所有動物");
        printAnimalArray(animals);
        System.out.println();

        // 指定位置插入
        System.out.println("指定位置插入");
        animals.addAnimal(cat2, 2);
        printAnimalArray(animals);
        System.out.println();

        // 指定位置刪除
        System.out.println("指定位置刪除");
        animals.removeAnimal(3);
        printAnimalArray(animals);
        System.out.println();

        // 照體重排序
        System.out.println("照體重排序");
        animals.sortAnimalsByWeight();
        printAnimalArray(animals);
        System.out.println();

        // 照名字排序
        System.out.println("照名字排序");
        animals.sortAnimalsByName();
        printAnimalArray(animals);
        System.out.println();
    }

    // 印出所有動物
    public static void printAnimalArray(AnimalArray animals) {
        for (int i = 0; i < animals.getAnimals().length; i++) {
            System.out.println(animals.getAnimals()[i]);
        }
    }
}
